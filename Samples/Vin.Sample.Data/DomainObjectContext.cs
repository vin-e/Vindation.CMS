...
namespace Vin.Sample.Data
{
    public class DomainObjectContext : DbContext, IDbContext
    {
        public DomainObjectContext()
        ...
        protected virtual TEntity AttachEntityToContext<TEntity>(TEntity entity) where TEntity : BaseIdEntity, new()
        {
        ...
        public IList<TEntity> ExecuteStoredProcedureList<TEntity>(string commandText, params object[] parameters) where TEntity : BaseIdEntity, new()
        {
